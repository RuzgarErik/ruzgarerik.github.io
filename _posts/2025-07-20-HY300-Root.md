...
![Cover image]({{ '/assets/hy300-root/kapak.png' | relative_url }})
...
1.  **Fastboot Moduna Geçiş:** Cihazınızı Fastboot moduna yeniden başlatın:
    ...
    ![The Android robot is reproduced from or contains modifications based on work created and shared by Google and used according to terms described in the Creative Commons 3.0 Attribution License.]({{ '/assets/hy300-root/fastboot.png' | relative_url }})
